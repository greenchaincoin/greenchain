...
const QString BITCOIN_IPC_PREFIX("Greenchain:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Greenchain: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Greenchain: click-to-pay handler");
    else
...
{
    // clicking on Greenchain: URLs creates FileOpen events on the Mac:

...
// Copyright (c) 2017 The Greenchain developers
...
uint256 hashGenesisBlock("0x00000283a023cb26be74f92492652abbb058c990d9a9970cf2d8771749081957");
static const unsigned int timeGenesisBlock = 1533981061;
...
const string strMessageMagic = "Greenchain Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "August 15, 2017. The Greenchain release. ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x871b51bb9ac9dba4625d50f0a94323fd47352fe8e377a1973cfa9430fb8e0dd5"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("GreenchainMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GreenchainMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("GreenchainMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Greenchain-miner");
    ...
    try { loop {
        ...
        printf("Running GreenchainMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("GreenchainMiner terminated\n");
        throw;
    }
}
